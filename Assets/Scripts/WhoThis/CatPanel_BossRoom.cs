...
public class CatPanel_BossRoom : MonoBehaviour
{
    ...
    public CatPanelCntrl_BossRoom catCntrl;
    ...
    private void Update()
    {
        if (playerIsNear && !panelPressed && Input.GetKeyDown(KeyCode.F))
        {
            panelPressed = true;
